...
import co.com.geonames.timezone.qa.api.screenplay.facts.PersonalInformation;
import co.com.geonames.timezone.qa.api.screenplay.questions.SchemaValidation;
...
public class CommonSteps {
    public void userHasPersonalInformationToLogin(String clientName) {
        ...
        theActorCalled(clientName).has(PersonalInformation.toLogin());
